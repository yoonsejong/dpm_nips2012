function [model] = dppca_m(X, MissIDX, V, E, M, ETA, THRESH, model_init, iter_obj)
% DPPCA_M      Distributed Probablistic PCA (D-PPCA) with Missing Values
% 
% Description
...
% simulates parameter broadcasts. Just like D-PPCA, local computation is
% done by dppca_m_local function.
%
% Input
...
while counter <= COUNTER_MAX
    ...
    for idx = 1 : J
        ...
        [Wnew, MUnew, PRECnew, EZn, EZnZnt, Fnew] = ...
            dppca_m_local(Xi{idx}, MissIDXi{idx}, M, idx, Bj{idx}, ETA, ...
