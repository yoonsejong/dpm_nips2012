...
parfor idk = 1:length(RATEArr)
    ...
    for idr = 1:5%1:20
        ...
        fprintf('* PPCA (EM) / %f *\n', RATE);
        cm1 = cppca_em_m(mm_trans, MissIDX, M, THRESHc, m_init1, objfreq_c);
        ...
        m_init2 = get_init_value('d_dup', mm_trans, M, 10, NV, m_init1);

        cm2 = dppca_m(mm_trans, MissIDX, Vp, E, M, ETA, THRESHd, m_init2, objfreq_dj);
