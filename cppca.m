...
% (D dimension)x(N observations) sample matrix X. Technically identical but 
% numerically slightly different from PMTK3 implementation (ppcaFit.m).
%
% Output
...
% E[Z]   = M^-1 * W' * (X - MU)
% E[ZZ'] = sigma^2 * M^-1 + E[Z]E[Z]' where M = W'W + sigma^2*I
