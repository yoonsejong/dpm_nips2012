function [model] = dppca_t(X, V, E, M, ETA, THRESH, model_init, iter_obj, SAVE_PATH)
% DPPCA_T      Distributed Probablistic PCA (D-PPCA) (Transposed)
% 
% Description
...
%            (Default 10)
% SAVE_PATH: String containing the save path for status of each iteration
%
% Output
...
while counter <= COUNTER_MAX
    ...
    for idx = 1 : J
        ...
        [Wnew, MUnew, PRECnew, EZn, EZnZnt, Fnew] = ...
            dppca_t_local(Xi{idx}, M, idx, Bj{idx}, ETA, ...
